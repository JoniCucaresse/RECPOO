namespace Ejercicio3.Entidades
{
    public class Kilos
    {
        ...
        public static explicit operator Kilos(Libras li)
        {
            return new Kilos((li.GetPeso()) * 0.45359237f);
        }
        ...
        public static Kilos operator +(Kilos k, Libras l)
        {
            return new Kilos(k.peso + (Kilos)l);
        }
    }
}
